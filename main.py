import os
from preprocessed_protocols.utils.file_conversion import data_converter, input_file_generator

# Get relative path for 'main.py'
dirname = os.path.dirname(__file__)

# Excel Workbook Data Path
XLSX_FILENAME = os.path.join(dirname, 'data/opentron template test example.xlsx')
...
READ_FILE = os.path.join(dirname, 'preprocessed_protocols/Basic_Transfer.py')

# Destination file path for new opentron input file
WRITE_FILE = os.path.join(dirname, "opentron_protocols/Basic_Transfer.py")
